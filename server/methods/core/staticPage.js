...
Meteor.methods({
  createStaticPage: function (pageTitle, pageURLAddress, pageContent, createdAt) {
    check(pageTitle, String);
    check(pageURLAddress, String);
  ...
  updateStaticPage: function (_id, pageTitle, pageURLAddress, pageContent, createdAt, updatedAt) {
    check(_id, String);
    check(pageTitle, String);
    check(pageURLAddress, String);
    check(pageContent, String);
